...
import { ProdutosSemelhantes } from '../../../components/Ferramentas/ProdutoDetalhe/ProdutosSemelhantes/ProdutosSemelhantes';
...
import { Acessorios } from '../../../components/Ferramentas/ProdutoDetalhe/Acessorios/Acessorios';
import { InfoVendedor } from '../../../components/Ferramentas/ProdutoDetalhe/InfoVendedor/InfoVendedor';
import { AvaliacaoSection } from '../../../components/Ferramentas/ProdutoDetalhe/AvaliacaoSection/AvaliacaoSection';
import { BannerLateral } from '../../../components/Ferramentas/ProdutoDetalhe/BannerLateral/BannerLateral';
...
export default function ProdutoDetalhe({ navigate }: ProdutoDetalheProps) {
  ...
  const handleContinuar = (dados: DadosLocacaoModal) => {
    ...
    if (produto.tipoAprovacao === 'manual') {
      ...
      const novaLocacao = adicionarLocacao(
        montarLocacaoPendente(produto, dados, usuario?.nome ?? 'Locatário'),
      );
