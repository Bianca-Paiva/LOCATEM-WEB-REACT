...
export const mockNotifications: NotificationData[] = [
  ...
  },
  {
    ...
    description: 'A devolução do Aparador De Grama Bipartido Tramontina deve ser feita amanhã.',
  ...
  },
  {
    ...
    description: 'A Serra Circular Profissional DESOON 24 Dentes está a caminho.',
    timestamp: '',
  ...
  },
  {
    ...
    description: 'O pagamento da locação da Parafusadeira e Furadeira WAP 12V ainda não foi confirmado.',
  ...
  },
  {
    ...
    description: 'A devolução da Betoneira está atrasada.',
