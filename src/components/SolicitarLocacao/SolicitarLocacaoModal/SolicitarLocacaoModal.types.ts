...
export interface LocacaoModalFormState {
...
export interface ResumoLocacaoModalCalculado {
...
export interface DadosLocacaoModal {
  produtoId?: number;
  dataEntrega: string;
  ...
  quantidade: number;
  resumo: ResumoLocacaoModalCalculado;
}
