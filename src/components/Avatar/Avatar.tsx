...
/**
 * Avatar único e reutilizável do projeto: mostra a foto do usuário quando existe, ou cai para as iniciais do nome quando não existe (mesmo padrão visual que já era usado em InfoVendedor, agora centralizado aqui para não duplicar em cada lugar que precisa exibir um usuário/locador — Header, Perfil, InfoVendedor).
 */
