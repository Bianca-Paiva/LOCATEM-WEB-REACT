  ...
  return (
    <section className={styles.card}>
      ...
      <div className={styles.aviso}>
        ...
        <div>
          <p>A devolução será coletada no mesmo endereço informado acima. Caso seja necessário alterar o local de coleta, isso poderá ser feito posteriormente na reserva.</p>
          <p>Você só será cobrado quando a reserva for aceita pelo locador.</p>
        </div>
      </div>
    </section>
  );
